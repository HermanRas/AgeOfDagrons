...
code effort, ~70 bakes behind it" since it was written — so it is paced by A.10 on the art side
and not by anything here. **5.3, building upgrades, is the code half and is already half-built**:
