...
| # | Item | Tag |
|---|---|---|
| 3.1 | Isometric render of the grid; `Iso` math; Y-sorted layers. **Must fix depth sorting for large footprints** Ã¢â‚¬â€ `Iso.depth_sort_key()` keys off a single tile, so an 8Ãƒâ€”8 town centre sorts as if it stood on its centre and the starting villagers draw on top of its roof (visible in `dev_preview/preview_world.tscn` at 2.6). Key a footprint off its front corner instead | **[MVP]** |
...
| # | Item | Tag |
|---|---|---|
| 4.1 | `MoveCommand` Ã¢â€ â€™ task/movement systems; stop at nearest reachable tile | **[MVP]** |
...
| 5.2 | Construction phases (foundation Ã¢â€ â€™ building Ã¢â€ â€™ complete) | **[MVP]** |
...
| 6.4 | Gather loop: walk Ã¢â€ â€™ cooldown Ã¢â€ â€™ carry cap Ã¢â€ â€™ return to drop-off Ã¢â€ â€™ repeat | **[MVP]** |
