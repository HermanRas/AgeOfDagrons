...
JSON registry. Art ships as downloadable packs — zips, mounted at every boot — rather than
bloating the APK, and re-skinning the entire game means swapping a pack, not editing code.
