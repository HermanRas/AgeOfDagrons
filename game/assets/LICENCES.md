...
| `vis.cliff_back` | `cliff_back.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_diag` | `cliff_back_diag.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_diag_long` | `cliff_back_diag_long.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_diag_medium` | `cliff_back_diag_medium.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_diag_short` | `cliff_back_diag_short.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_long` | `cliff_back_long.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_medium` | `cliff_back_medium.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_back_short` | `cliff_back_short.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1, crest cut)` | [Project asset](https://policies.google.com/terms) |
...
| `vis.cliff_face_diag` | `cliff_face_diag.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_diag_long` | `cliff_face_diag_long.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_diag_medium` | `cliff_face_diag_medium.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_diag_short` | `cliff_face_diag_short.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_long` | `cliff_face_long.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_medium` | `cliff_face_medium.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
| `vis.cliff_face_short` | `cliff_face_short.toml` | `assets/Cliff_Gen/sheet_cliff_faces_v2.jpg (strip 1)` | [Project asset](https://policies.google.com/terms) |
...
| `ui/icons/cat_units.png` | The UNITS page on the build menu (`8.x-build-menu-modal`, owner 2026-09-20). **A MapMaker CATEGORY icon reused as a game HUD verb** and deliberately not renamed — the shared name is the thread back when that set is next re-cut. Copied by hand from `assets/UI_Gen/sliced/icons/`, the move 16.6 made in the other direction with `lobby_victory.png` | **AI-generated** by the project owner using **Google Gemini** (paid account) | Project asset — see the note below |
