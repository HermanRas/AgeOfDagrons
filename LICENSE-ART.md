...
| The dragon's **rig and animation clips** (baked into `vis.dragon_rigged`) | MIT-style, **but declared and shipped as CC-BY-SA 3.0** | 0 A.D.'s dragon mesh has no armature, so the rig and its five clips were commissioned separately. ⚠️ **Owner's decision, 2026-09-04: the combined asset goes out under 0 A.D.'s terms**, because where two licences meet the stricter governs — and honouring CC-BY-SA 3.0 satisfies MIT, which permits everything share-alike does and more. So this row changes nothing about what ships; it records that the baked frames have a second source. Fuller note in [`game/assets/LICENCES.md`](game/assets/LICENCES.md) |
